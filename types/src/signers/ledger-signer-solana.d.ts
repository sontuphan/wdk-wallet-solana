...
export default class LedgerSignerSol implements ISignerSolana {
    /**
     * @constructor
     * @param {string} path The SLIP-0010 derivation path (e.g. "0'/0'"). Note that, All child paths must be hardened in Solana.
    ...
    /**
     * Derive child signer
     * @param {string} relPath The SLIP-0010 derivation path (e.g. "0'/0'"). Note that, All child paths must be hardened in Solana.
